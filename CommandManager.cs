...
namespace GUG.Packages.KBCodeReview
{
    class CommandManager : CommandDelegator
	{
		public CommandManager()
		{
            ...
            AddCommand(CommandKeys.RequestReview, new ExecHandler(ExecRequestReview), new QueryHandler(EnableWhenKbOpened));
        ...
        public bool ExecRequestReview(CommandData cmdData)
        {
           
           KBCodeReviewHelper.RequestCodeReview();
            return true;
        }
